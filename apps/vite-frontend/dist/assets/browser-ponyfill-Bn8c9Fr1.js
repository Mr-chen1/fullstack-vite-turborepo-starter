import {c as R, g as z} from './index-j8C9iF24.js';
function X(w, d) {
                          ...
                          : f.formData && FormData.prototype.isPrototypeOf(e)
                            ...
                            : f.searchParams && URLSearchParams.prototype.isPrototypeOf(e)
                              ...
                              : f.arrayBuffer && f.blob && S(e)
                                ...
                                : f.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(e) || I(e))
...
`) === 0
            ...
            function O(e, t) {
              return new Promise(function (r, n) {
                ...
                ((o.onload = function () {
                  var l = {status: o.status, statusText: o.statusText, headers: N(o.getAllResponseHeaders() || '')};
            ...
            return (
              (O.polyfill = !0),
              a.fetch || ((a.fetch = O), (a.Headers = s), (a.Request = m), (a.Response = c)),
              (u.Headers = s),
              (u.Request = m),
              (u.Response = c),
              (u.fetch = O),
...
var j = J();
const K = z(j),
  W = X({__proto__: null, default: K}, [j]);
export {W as b};
